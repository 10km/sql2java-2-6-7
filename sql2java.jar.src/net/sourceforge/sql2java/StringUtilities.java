...
public final class StringUtilities {
	...
	static String latin[] = {"Ac", "Aethiopia", "Africae", "Anazarbus", "Argonautarum", "Ciliciam", "Cydno", "Danaes,",
			...
			"continentur.", "cum", "cunctorum.", "dediti", "delatumque", "dicendi", "dici", "direpto", "disciplina,",
			"distarent,", "dolorem", "dolorum", "domicilium", "ductores", "eius", "eo", "errore", "et", "eum", "ex",
			"explicatis", "exultat,", "facultas", "feriens", "filius", "forte", "fuimus.", "gestu", "habent", "habitus",
			"haec", "hanc", "hastisque", "haut", "heroici", "hoc", "huic", "humanitatem", "iam", "illius", "in",
			"ingeni,", "intempestivum", "inter", "iram", "ita", "litus", "locari", "longe", "manes", "medentur",
			"memoratur,", "miles", "miretur,", "mors", "muri", "ne", "neque", "nobilis", "nobilitat,", "nobis",
			"nomine", "nos", "occurrere", "omnes", "opulentus", "ordinibus", "parans", "penitus", "perspicabilis",
			"pertinax", "pertinent,", "plerumque", "poterat", "profectus", "proximos", "pugnantium", "punico", "quadam",
			"quae", "quaedam", "quasi", "quem", "qui", "quidam", "quidem", "quis", "quod", "quoddam", "quorum", "rati",
	...
	public static String convertClass(Table table, String type) {
		return convertClass(table.getName(), type);
	}
